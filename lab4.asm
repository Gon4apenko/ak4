...
Start:
    ...
    loop1:
        ...
        mov [ds:[si+512]],ax
        add si, 2            ; збільшуємо по 2 байти так як використовуємо слово
    ...
    mov [ss:0730h], 0320h    ; записуємо значення 2003 в стек
	mov [ss:0740h], 0508h    ; записуємо значення 0805 в стек
	mov [ss:0750h], 0220h    ; записуємо значення 2002 в стек
	mov [ss:0760h], 0201h    ; записуємо значення 0102 в стек
	mov [ss:0770h], 0320h    ; записуємо значення 2003 в стек
	mov [ss:0780h], 1003h    ; записуємо значення 0310 в стек
